                    ...
                    @include('allinfo.messages')
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" value="" placeholder="Product Description">{{ $product->description }}</textarea>
                      </div>
                       <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="offerprice" value="{{ $product->offer_price}}" class="form-control" placeholder="Product Offer Price">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="submit" name="addProduct" value="Update Value" class="btn btn-primary btn-block">
                      </div>
