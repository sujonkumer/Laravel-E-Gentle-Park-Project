      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Products</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{ Route('Backend.pages.product.createproduct')}}"><i class="icon fa fa-circle-o"></i>Add New Product</a></li>
            <li><a class="treeview-item" href="{{ Route('Backend.pages.product.manageproduct')}}" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i> Manage Product</a></li>
          </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Category</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{ Route('createcategory')}}"><i class="icon fa fa-circle-o"></i>Add New Category</a></li>
            <li><a class="treeview-item" href="{{ Route('managecategory')}}" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i> Manage Category</a></li>
          </ul>
        </li>
